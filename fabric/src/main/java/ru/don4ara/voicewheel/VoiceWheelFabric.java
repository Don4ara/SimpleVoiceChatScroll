...
public class VoiceWheelFabric implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        LevelRenderEvents.AFTER_TRANSLUCENT_FEATURES.register(VoiceWheelFabric::renderVolumeIndicators);
    }
