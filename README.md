...
This branch builds the Minecraft 1.21.2 universal JAR for Fabric and NeoForge.
...
`v0.0.2-mc1.21.2`. The release asset is:

- `SimpleVoiceChatScroll-0.0.2+mc1.21.2-universal.jar`
