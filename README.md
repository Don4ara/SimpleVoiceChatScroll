...
This branch builds the Minecraft 26.1 universal JAR for Fabric, Forge, NeoForge.
...
`v0.0.3-mc26.1`. The release asset is:

- `SimpleVoiceChatScroll-0.0.3+mc26.1-universal.jar`
