...
This branch builds the Minecraft 1.21.7 universal JAR for Fabric, Forge, NeoForge.
...
`v0.0.3-mc1.21.7`. The release asset is:

- `SimpleVoiceChatScroll-0.0.3+mc1.21.7-universal.jar`
