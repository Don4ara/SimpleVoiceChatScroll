...
This branch builds the Minecraft 1.21.6 universal JAR for Fabric, Forge, NeoForge.
...
`v0.0.3-mc1.21.6`. The release asset is:

- `SimpleVoiceChatScroll-0.0.3+mc1.21.6-universal.jar`
