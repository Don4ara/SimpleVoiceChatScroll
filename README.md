...
This branch builds the Minecraft 1.21.4 universal JAR for Fabric, Forge, NeoForge.
...
`v0.0.2-mc1.21.4`. The release asset is:

- `SimpleVoiceChatScroll-0.0.2+mc1.21.4-universal.jar`
